...
export const BankContactReminderNew = () => {
  const { t, i18n }= useTranslation ('global')
  return (
    <>
      <Header/>
      <div className="md:container mx-auto flex justify-center bg-sky-100">
          <h1 className="text-rose-400 items-center mx-auto">{ t('newAccount.title') }</h1>
      </div>
      <div className="grid grid-cols-1 flex-wrap bg-slate-300 lg:m-4   md:mx-auto my-auto rounded-2xl items-center
            ...
            <form className="mx-auto bg-slate-200 border-2 border-double flex-wrap pt-10 pl-20 pr-20 pb-10 border-red-200 rounded-3xl w-200 
              ...
              {/**Imput email */}
              <div className="relative mt-2 rounded shadow-sm w-80">
                <input type="email" className="boder-2 border-red-200 bg-slate-50 py-2 pr-3 pl-10 w-full px-4 rounded-2xl  outline-none"
                       placeholder={ t('newAccount.txtEmail') } name="email"/>
                <div className="absolute inset-y-0 left-0 flex items-center">
              ...
              {/**input Password */}
              <div className="relative mt-2 rounded shadow-sm w-80">
                <input type="password" className="boder-2 border-red-200 bg-slate-50 py-2 pr-3 pl-10 w-full px-4 rounded-2xl  outline-none"
                       placeholder={ t('newAccount.txtPassword') } name="password"/>
                <div className="absolute inset-y-0 left-0 flex items-center">
              ...
              <div className="relative mt-2 rounded shadow-sm w-80">
                <input type="password" className="boder-2 border-red-200 bg-slate-50 py-2 pr-3 pl-10 w-full px-4 rounded-2xl  outline-none"
                       placeholder={ t('newAccount.txtConfirmPass') } name="confirmPassword"/>
                <div className="absolute inset-y-0 left-0 flex items-center">
                  <svg className="h-8 w-8 text-red-300"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" 
                          d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/>
              ...
              <div className="relative mt-2 rounded shadow-sm text-center pt-4 w-80">
                ...
                <div>
                  <i className="text-slate-500">{ t('newAccount.creatAccount') } <Link to={ '/logIn' }><span className="text-sky-500">{ t('newAccount.logIn') }</span></Link></i>
                </div>
